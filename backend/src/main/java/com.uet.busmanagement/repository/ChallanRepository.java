...
public class ChallanRepository
{
    ...
    {
        String query = "INSERT INTO challans (challan_number, student_id, amount, due_date, status, issue_date, fine) VALUES (?, ?, ?, ?, ?, ?, ?)";
    ...
    public List<Challan> findByStudentId(String regnum)
    {
        ...
        String query = "SELECT * FROM challans WHERE regnum = ?";
