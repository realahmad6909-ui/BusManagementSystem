...
public class UserRepository {
    ...
    // 1. Naye User ko database mien save (register) karne ke liye
    public boolean save(User user) {
        String query = "INSERT INTO users (user_id, name, email, password, role, phone, profile_pic_path) VALUES (?, ?, ?, ?, ?, ?, ?)";
        ...
        try (Connection conn = db.initializeDatabase();
            ...
            stmt.setString(7, user.getProfilePicPath());
